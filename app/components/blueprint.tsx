...
export default function Blueprint({ className, ...rest }: BlueprintProps) {
  return (
    <div className={classMerge('h-full w-full shrink-0 relative', className)} {...rest}>
      <div className="overflow-hidden h-full w-full">
        <svg
          id={ID_BLUEPRINT_CROSS}
          width="100%"
          height="100%"
          viewBox="0 0 789 789"
          fill="none"
      ...
      <div id={ID_BLUEPRINT_CENTRE} className="absolute inset-0 h-full w-full">
        <svg
